...
class ThreadTimelineTests(unittest.TestCase):
    ...
    def test_mixed_sender_addresses_cannot_apply_internal_outcome(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
    ...
    def test_display_name_with_one_internal_address_remains_internal(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
    ...
    def test_all_internal_multi_address_sender_remains_internal(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "body_text": "Please provide quotation RFQ-3.",
            },
            {
                "position": "2",
    ...
    def test_malformed_mixed_sender_list_cannot_apply_internal_outcome(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "body_text": "Please provide quotation RFQ-6.",
            },
            {
                "position": "2",
    ...
    def test_invalid_internal_address_candidate_cannot_apply_outcome(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "body_text": "Please provide quotation RFQ-8.",
            },
            {
                "position": "2",
    ...
    def test_chinese_negated_completion_does_not_resolve_request(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "body_text": "请提供RFQ-2报价。",
            },
            {
                "position": "2",
                "from": "Sales <sales@cndlf.com>",
    ...
    def test_double_negative_completion_stays_conservatively_unresolved(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
    ...
    def test_unrelated_negative_does_not_cancel_explicit_completion(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "body_text": "Please provide quotation RFQ-4.",
            },
            {
                "position": "2",
                "from": "Sales <sales@cndlf.com>",
    ...
    def test_modal_negated_completion_does_not_resolve_request(self) -> None:
        negative_outcomes = (
            "RFQ-7 quotation cannot be completed.",
            "RFQ-7 quotation could not be completed.",
            "RFQ-7 报价无法完成。",
            "RFQ-7 报价不能完成。",
        )
                ...
                segments = [
                    {
                        "position": "1",
                        "from": "Buyer <buyer@example.org>",
                        "body_text": "Please provide quotation RFQ-7.",
                    },
                    {
                        "position": "2",
                        "from": "Sales <sales@cndlf.com>",
    ...
    def test_future_passive_negation_does_not_resolve_request(self) -> None:
        negative_outcomes = (
    ...
    def test_later_blocker_reopens_matching_resolved_request(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
    ...
    def test_later_completion_clears_matching_blocker(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
    ...
    def test_coordinated_line_requests_remain_atomic(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "body_text": "Please provide quotation for line 1 and line 2.",
            },
            {
                "position": "2",
                "from": "Sales <sales@cndlf.com>",
    ...
    def test_folded_fallback_from_header_preserves_continuation_addresses(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "body_text": "Please provide quotation RFQ-30.",
            },
            {
                "position": "2",
                "header_text": (
        ...
        self.assertEqual(result["current_status"], "unresolved")
        self.assertFalse(
            result["current_status"] == "resolved" and result["confidence"] == "high"
        )
        self.assertNotIn("buyer@example.com", str(result))
        self.assertNotIn("From:", str(result))
    ...
    def test_equivalent_identifier_only_subject_and_body_request_is_tracked_once(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.com>",
                "subject": "Please confirm PART-204",
    ...
    def test_equivalent_subject_body_request_preserves_nonempty_due_hint(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "subject": "Quotation request RFQ-1",
                "body_text": "Please provide quotation RFQ-1 by 2026-07-20.",
            }
        ]
    ...
    def test_equivalent_subject_body_request_preserves_same_due_hint(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "subject": "Quotation request RFQ-2 due 2026-07-20",
                "body_text": "Please provide quotation RFQ-2 by 2026-07-20.",
            }
        ]
    ...
    def test_conflicting_subject_body_due_hints_require_manual_review(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "subject": "Quotation request RFQ-3 due 2026-07-12",
                "body_text": "Please provide quotation RFQ-3 by 2026-07-20.",
            }
        ]
        ...
        self.assertEqual(result["confidence"], "low")
        self.assertIn("人工复核", result["open_items"][0]["item"])
        self.assertEqual(result["open_items"][0]["due_hint"], "")

    def test_repeated_identifier_only_body_requests_remain_distinct(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.com>",
                "body_text": "Please confirm PART-205. Please confirm PART-205.",
            },
            {
                "position": "2",
                "from": "Sales <sales@cndlf.com>",
    ...
    def test_confirm_receipt_of_request_does_not_create_request(self) -> None:
        result = build_conversation_timeline(
            [
                {
                    "position": "1",
    ...
    def test_please_note_received_request_does_not_create_request(self) -> None:
        result = build_conversation_timeline(
            [
                {
                    "position": "1",
    ...
    def test_chinese_received_request_acknowledgement_creates_no_request(self) -> None:
        result = build_conversation_timeline(
            [
                {
                    "position": "1",
    ...
    def test_coordinated_request_title_applies_to_each_bare_topic(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "subject": "Quotation and certificate request",
            },
            {
                "position": "2",
                "from": "Sales <sales@cndlf.com>",
    ...
    def test_three_item_coordinated_request_title_tracks_every_topic(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "subject": "Quotation, certificate and shipment request",
            },
            {
                "position": "2",
                "from": "Sales <sales@cndlf.com>",
    ...
    def test_chinese_coordinated_request_title_tracks_every_topic(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
    ...
    def test_acknowledgement_clause_does_not_hide_later_direct_request(self) -> None:
        result = build_conversation_timeline(
            [
                {
                    "position": "1",
        ...
        self.assertEqual(result["current_status"], "unresolved")
        self.assertIn("RFQ-2", result["latest_external_request"])
        self.assertEqual(len(result["open_items"]), 1)

    def test_attached_request_reference_does_not_create_work(self) -> None:
        result = build_conversation_timeline(
            [
                {
                    "position": "1",
    ...
    def test_declarative_acknowledgement_and_attachment_create_no_work(self) -> None:
        phrases = (
            "The requested quotation RFQ-1 is attached.",
            "We confirm quotation RFQ-1.",
        )
    ...
    def test_imperative_confirm_remains_a_request(self) -> None:
        result = build_conversation_timeline(
            [
                {
                    "position": "1",
        ...
        self.assertEqual(result["current_status"], "unresolved")
        self.assertIn("RFQ-1", result["latest_external_request"])

    def test_declarative_clause_does_not_hide_later_direct_request(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.org>",
                "body_text": (
                    "We confirm quotation RFQ-1, "
                    "but please provide certificate PART-2."
                ),
            },
            {
                "position": "2",
    ...
    def test_subject_truncation_requires_manual_review(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.com>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "subject": (
                    "RFQ-501 quotation request. "
                    + ("x" * 520)
                    + " Please provide certificate PART-502."
                ),
            },
            {
                "position": "2",
    ...
    def test_sender_truncation_cannot_hide_external_participant(self) -> None:
        segments = [
            {
                "position": "1",
                "from": "Buyer <buyer@example.com>",
                "sent_at": "2026-07-10T09:00:00+00:00",
                "body_text": "Please provide quotation RFQ-502.",
            },
            {
                "position": "2",
                "from": (
                ...
                "sent_at": "2026-07-10T10:00:00+00:00",
                "body_text": "RFQ-502 quotation completed.",
            },
        ]
