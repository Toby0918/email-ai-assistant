...
class RolloutCloseoutContractTests(unittest.TestCase):
    ...
    def test_testing_checklist_has_complete_offline_release_sequence(self) -> None:
        ...
        for required in (
            "manage_mailbox_vault.py init",
            "manage_mailbox_vault.py inventory",
            "--confirm-inventory-fingerprint",
            "attachment approval",
            "50",
            "manage_mailbox_vault.py verify",
            "manage_mailbox_vault.py purge-expired",
            "manage_mailbox_vault.py revoke",
            "manage_mailbox_vault.py rewrap-recovery",
            "manage_private_knowledge.py",
            "manage_private_knowledge.py publish",
