...
[ ] Fresh maintenance evidence requires exactly twenty-two reviewed low-risk `(severity, category, path, doc)` classifications; missing, duplicate, or additional classifications fail closed.
